    ...
    <Navbar bg="dark" variant="dark" expand="lg" className="shadow-sm">
      <Container>
        <Navbar.Brand as={Link} to="/">
          <img
            src="account_logo.jpg-7852c33c-0409-4411-bec7-bc55abaf5658" // Your uploaded logo
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto">
            ...
            <Button as={Link} to="/contact" variant="outline-info" className="ms-lg-3 my-2 my-lg-0 rounded-pill">
